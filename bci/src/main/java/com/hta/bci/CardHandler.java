...
public class CardHandler {
    ...
    public CardHandler(Context context, Boolean message) {
        log = message;
        ...
        banks.put("622105", "بانک پارسیان");
        banks.put("629194", "بانک پارسیان");
    ...
    public String BankName(String cardNo) {
    ...
    public String BankNameForTextWatcher(String cardNo) {
        if (banks.containsKey(cardNo.substring(0, 6))) {
            String bank = (String) banks.get(cardNo.substring(0, 6));
            return bank;
        } else {
    ...
    public int BankLogo(String bankName) {
